...
# Rimuovi le righe che contengono '/noauth_get_status/' nell'URL
df_metric = df_metric[~df_metric['url'].str.contains('/noauth_get_status/')]
...
plt.title(f'Latenza richieste http (senza richieste di stato)')
plt.xlabel('Tempo [s]')
